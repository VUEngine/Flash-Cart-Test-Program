...
const uint32 AdjustmentIconLEntityAdjustmentIconLTiles[] __attribute__((aligned(4))) =
{
	0x00000000,
...
const uint16 AdjustmentIconLEntityAdjustmentIconMap[] __attribute__((aligned(4))) =
{
