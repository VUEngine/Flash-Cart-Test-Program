...
const uint32 AdjustmentIconREntityAdjustmentIconRTiles[] __attribute__((aligned(4))) =
{
	0x00000000,
...
const uint16 AdjustmentIconREntityAdjustmentIconMap[] __attribute__((aligned(4))) =
{
